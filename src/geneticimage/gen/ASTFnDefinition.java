...
public class ASTFnDefinition extends FnParseNode implements Compileable {
    ...
    public void setEval(ASTFnBlock eval) {this.eval = eval;}
    public void setEstimate(ASTFnBlock estimate) {this.estimate = estimate;}
    public void setInit(ASTFnBlock init) {this.init = init;}
    public void setLocal(ASTLocal local) {this.local = local;}
    public void setMeta(ASTMeta meta) {this.meta = meta;}
    public void setSetup(ASTFnBlock setup) {this.setup = setup;}
    public void setNecessaryContext(ASTFnBlock necessaryContext) {this.necessaryContext = necessaryContext;}
    ...
    public void setOut(ASTOut out) {this.output = out;}
    public void addIn(ASTIn in) {this.inputs.add(in);}
    public void addInterface(ASTOut intf) {this.interfaces.add(intf);}
    public void addNBIn(ASTNBIn in) {this.nbInputs.add(in);}
    public void addParameter(ASTIn in) {this.parameters.add(in);}
    
    public boolean isNodeBase() {return !nbInputs.isEmpty();}
    ...
    public ClassDescriptor compileToJava() throws CompileException {
        ...
        if(nbInputs.isEmpty())
            thisClass.extendsClass = "NodeFunction";
        else {
        ...
        if(init != null) {
            ...
            if(!nbInputs.isEmpty()) { // for nodebased, add nff constructor
                initMeth.addArgument("NodeFunctionFactory","nff");
